...
export const VENUES: Venue[] = [
  ...
  },
  {
    ...
    theme: {
      ...
      chip: "bg-zinc-100 text-zinc-900",
      text: "text-zinc-900",
    },
  },
  {
...
export const PARTIES: Party[] = [
  ...
  // ──────────────────────────── Pink Mammoth ────────────────────────────
  //
  // Ocho días seguidos en la plaza de 9 & G, y el único cartel que cubre el
  // domingo de apertura y el de cierre. Es fiesta de día: abre a mediodía y
  // cierra al caer el sol, así que el icono del sol marca aquí el atardecer y
  // no el amanecer, al revés que en los art cars.
  //
  // De cada día se sabe cuándo abre y cuándo cierra, así que los sets se
  // reparten a partes iguales entre las dos horas, redondeando a cinco minutos.
  {
    id: "pm-sun-open",
    venueId: "pink-mammoth",
    date: "2026-08-30",
    name: "Opening Party",
    kind: "day",
    start: "18:00",
    setMinutes: 45,
    note: "El cartel solo da las 18:00 de apertura. Con cuatro nombres y el sol puesto en Alec de Reitzes, salen sets de 45 minutos y la fiesta se va a las 21:00.",
    sets: [
      { id: "pm-sun-open-dave",  label: "Dave Benedict",     artists: ["Dave Benedict"],     start: null },
      { id: "pm-sun-open-nick",  label: "Nick Granado",      artists: ["Nick Granado"],      start: null },
      { id: "pm-sun-open-alec",  label: "Alec de Reitzes",   artists: ["Alec de Reitzes"],   start: null, sun: "atardecer" },
      { id: "pm-sun-open-pm",    label: "PM and Friends",    artists: ["PM and Friends"],    start: null },
    ],
  },
  {
    id: "pm-mon",
    ...
    setMinutes: 75,
    note: "El cartel da la hora de apertura y de cierre de cada día, y marca con un sol el set del atardecer. Los nombres se reparten a partes iguales entre esas dos horas, que es lo que hace caer el sol donde el cartel lo pone.",
    sets: [
      { id: "pm-mon-mirii",     label: "DJ Mirii",                     artists: ["DJ Mirii"],                     start: null },
      { id: "pm-mon-greg",      label: "Greg Eversoul",                artists: ["Greg Eversoul"],                start: null },
      { id: "pm-mon-alec",      label: "Alec de Reitzes",              artists: ["Alec de Reitzes"],              start: null },
      { id: "pm-mon-grudi",     label: "Gru.Di B2B Reza",              artists: ["Gru.Di", "Reza"],               start: null },
      { id: "pm-mon-rob",       label: "Rob Adelmann",                 artists: ["Rob Adelmann"],                 start: null },
      { id: "pm-mon-enamour",   label: "Enamour",                      artists: ["Enamour"],                      start: null },
      { id: "pm-mon-nacho",     label: "Nacho Isa B2B Madmotormiquel", artists: ["Nacho Isa", "Madmotormiquel"], start: null, sun: "atardecer", note: "en el cartel, Nacho b2b Madmotomiquel" },
    ],
  },
  {
    id: "pm-tue",
    ...
    note: "El cartel da la hora de apertura y de cierre de cada día, y marca con un sol el set del atardecer. Los nombres se reparten a partes iguales entre esas dos horas, que es lo que hace caer el sol donde el cartel lo pone.",
    sets: [
      { id: "pm-tue-nick",      label: "Nick Granado",                artists: ["Nick Granado"],              start: null },
  ...
  },
  {
    ...
    note: "El cartel da la hora de apertura y de cierre de cada día, y marca con un sol el set del atardecer. Los nombres se reparten a partes iguales entre esas dos horas, que es lo que hace caer el sol donde el cartel lo pone.",
    sets: [
      { id: "pm-wed-henry",     label: "Henry Pope B2B Summer Almeida",  artists: ["Henry Pope", "Summer Almeida"],  start: null },
      { id: "pm-wed-christian", label: "Christian Voldstad",             artists: ["Christian Voldstad"],            start: null },
      { id: "pm-wed-anton",     label: "Anton Tumas",                    artists: ["Anton Tumas"],                   start: null },
      { id: "pm-wed-gorje",     label: "Gorje Hewek",                    artists: ["Gorje Hewek"],                   start: null },
      { id: "pm-wed-deer",      label: "Deer Jade B2B Sebastian Konrad", artists: ["Deer Jade", "Sebastian Konrad"], start: null },
      { id: "pm-wed-rodriguez", label: "Rodriguez Jr B2B Arodes",        artists: ["Rodriguez Jr", "Arodes"],        start: null, sun: "atardecer" },
      { id: "pm-wed-jules",     label: "Jules Thorne",                   artists: ["Jules Thorne"],                  start: null },
    ],
  },
  {
    id: "pm-thu",
    ...
    start: "12:00",
    setMinutes: 105,
    note: "El cartel dice \"noon - late\" y no da cierre. Con seis nombres y el sol en Lost Desert B2B Pippi Ciez, salen sets de hora y tres cuartos y la fiesta llega a las 22:30.",
    sets: [
      { id: "pm-thu-pomboklap", label: "Pomboklap",                   artists: ["Pomboklap"],                  start: null },
      { id: "pm-thu-igor",      label: "Igor Marijuan",               artists: ["Igor Marijuan"],              start: null },
      { id: "pm-thu-double",    label: "Double Touch",                artists: ["Double Touch"],               start: null, live: true },
      { id: "pm-thu-roy",       label: "Roy Rosenfeld",               artists: ["Roy Rosenfeld"],              start: null },
      { id: "pm-thu-lost",      label: "Lost Desert B2B Pippi Ciez",  artists: ["Lost Desert", "Pippi Ciez"],  start: null, sun: "atardecer" },
      { id: "pm-thu-emiom",     label: "EMIÔM · DWSM · ADMONIC · OKAM", artists: ["EMIÔM", "DWSM", "ADMONIC", "OKAM"], start: null, note: "los cuatro en el mismo bloque, sin orden" },
    ],
  },
  {
    id: "pm-fri",
    ...
    note: "El cartel da la hora de apertura y de cierre de cada día, y marca con un sol el set del atardecer. Los nombres se reparten a partes iguales entre esas dos horas, que es lo que hace caer el sol donde el cartel lo pone.",
    sets: [
      { id: "pm-fri-natipitch", label: "Natipitch",         artists: ["Natipitch"],         start: null },
      { id: "pm-fri-alchemist", label: "Alchemist Spider",  artists: ["Alchemist Spider"],  start: null },
      { id: "pm-fri-ares",      label: "Arēs",              artists: ["Arēs"],              start: null },
      { id: "pm-fri-augustine", label: "Augustine",         artists: ["Augustine"],         start: null },
      { id: "pm-fri-monobase",  label: "Monobase",          artists: ["Monobase"],          start: null },
      { id: "pm-fri-amine",     label: "Amine K",           artists: ["Amine K"],           start: null },
      { id: "pm-fri-zach",      label: "Zach Walker",       artists: ["Zach Walker"],       start: null, sun: "atardecer" },
    ],
  },
  {
    id: "pm-sat",
    ...
    note: "El cartel da la hora de apertura y de cierre de cada día, y marca con un sol el set del atardecer. Los nombres se reparten a partes iguales entre esas dos horas, que es lo que hace caer el sol donde el cartel lo pone.",
    sets: [
      { id: "pm-sat-sapphira", label: "Sapphira Solstice", artists: ["Sapphira Solstice"], start: null },
      { id: "pm-sat-david-b",  label: "David Benedict",    artists: ["David Benedict"],    start: null },
      { id: "pm-sat-lola",     label: "Lola Jak",          artists: ["Lola Jak"],          start: null },
      { id: "pm-sat-hohme",    label: "David Hohme",       artists: ["David Hohme"],       start: null },
      { id: "pm-sat-rob",      label: "Rob Adelmann",      artists: ["Rob Adelmann"],      start: null },
      { id: "pm-sat-marques",  label: "Marques Wyatt",     artists: ["Marques Wyatt"],     start: null, sun: "atardecer" },
    ],
  },
  {
    id: "pm-sun-close",
