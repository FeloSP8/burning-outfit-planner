  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className="ml-auto flex h-9 w-9 items-center justify-center rounded-lg text-[#7a3a10] hover:bg-[#c4822a]/20 md:hidden"
      >
      ...
      {open && (
        <div className="absolute left-0 right-0 top-full border-b border-[#b8956a]/20 bg-[#e8c99a]/95 backdrop-blur-md md:hidden">
