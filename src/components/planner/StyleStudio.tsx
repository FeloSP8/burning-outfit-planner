 ...
 * variantes cambiando solo el peinado, el tinte, el vello facial, el maquillaje
 * o los complementos de cabeza. Cualquier look se puede convertir en la foto de
 * modelo que usa el probador virtual.
 */
  ...
  return (
    <section className="rounded-2xl border border-[#c4906a]/30 bg-[#f5e0b8]/50 p-5">
      <div className="flex flex-wrap items-baseline justify-between gap-2">
        ...
        <p className="text-[11px] font-medium text-[#7a5030]">
          Cambia peinado, tinte, bigote o maquillaje sobre tu propia foto.
        </p>
      </div>

      {!userPhotoUrl && looks.length === 0 ? (
        <div className="mt-4 flex flex-col items-center gap-2 rounded-xl border-2 border-dashed border-[#c4906a]/40 py-10 text-center">
          <span className="text-4xl opacity-30">💇</span>
          <p className="text-sm font-medium text-[#a07040]">
            Sube tu foto en «Tu foto · Probador» para empezar a probar estilismos.
          </p>
        </div>
      ) : (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows={2}
                maxLength={300}
                placeholder="Ej: patillas largas y una trenza lateral con cuentas doradas"
