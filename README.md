...
- **♥ Mis DJs**: cada usuario marca los artistas que le interesan y suben a un bloque propio arriba de la lista, antes del resto. Con 188 nombres, rebuscar los cuatro que importan cada vez que abres la página no es agenda, es trabajo. Es personal, no compartido, y se guarda en `FavoriteArtist`
