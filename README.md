...
- **Cada cartel nuevo trae deberes**: los artistas que aparecen por primera vez se buscan uno a uno y se les rellena la ficha —género, contexto, Instagram, vídeo—. No todos salen: de los 19 nombres nuevos de Bipolar Express y Discotique se encontraron 13, y los 3 de Secular Sabbath entraron completos. El que no aparece en una búsqueda se queda sin ficha antes que con un handle inventado, que es un enlace a un desconocido
